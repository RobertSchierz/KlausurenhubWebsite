...
if($_FILES['uploadedfile']['error'] > 0){
    outputJSON('1', $_FILES['uploadedfile']['name'] );
}


// Check filetype
if($_FILES['uploadedfile']['type'] != 'application/pdf'){
    outputJSON('2', $_FILES['uploadedfile']['name'] );
}

// Check filesize
if($_FILES['uploadedfile']['size'] > 500000){
    outputJSON('3', $_FILES['uploadedfile']['name'] );
}

// Check if the file exists
if(file_exists('../altklausuren/' . $_FILES['uploadedfile']['name'])){
    outputJSON('4', $_FILES['uploadedfile']['name'] );
}
...
// Success!
outputJSON('5', $_FILES['uploadedfile']['name'] );